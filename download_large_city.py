...
snapshot_download(
    repo_id=REPO_ID,
    repo_type="dataset",
    allow_patterns="big_city/street/*.json",
...
snapshot_download(
    repo_id=REPO_ID,
    repo_type="dataset",
    allow_patterns="big_city/street/test/*",
    local_dir=DESTINATION_DIR,
    resume_download=True
)
...
# OPTION A: Download ONLY Block 1 (Safe start)
print("--> Downloading Train Set (Block 1 Only)...")
snapshot_download(
    repo_id=REPO_ID,
    repo_type="dataset",
    allow_patterns="big_city/street/train/block_1.tar",
    local_dir=DESTINATION_DIR,
    resume_download=True
)

#OPTION B: Download EVERYTHING (Uncomment to get full ~1.5TB)
print("--> Downloading ALL Train Blocks (Warning: Huge)...")
snapshot_download(
    repo_id=REPO_ID,
    repo_type="dataset",
    allow_patterns="big_city/street/train/*",
    local_dir=DESTINATION_DIR,
    resume_download=True
)

print("Big City download complete!")
